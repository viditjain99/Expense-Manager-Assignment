    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(output==null)
        {
            ...
            if(type==1)
            {
                ...
                viewHolder.title=expenseName;
                viewHolder.amount=expenseAmount;
                viewHolder.date=expenseDate;
                viewHolder.time=expenseTime;
        ...
        if(type==1)
        {
            ...
            viewHolder.amount.setText(String.valueOf(expense.getAmount()));
